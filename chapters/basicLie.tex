...
\end{align}
The set $\{X \oplus \eta^i\}_{i \in I}$ will be called \emph{a family of trivializations of $\oid X \in A$}.
...
\begin{eqnsplit}
    ...
    \stilde \eta &\mapsto (\sigma_i(m)g \mapsto Ad_{g^{-1}}(\stilde \eta_m))  \quad \textrm{for any $m \in M$, $g \in G$}.
\end{eqnsplit}
\end{definition}
