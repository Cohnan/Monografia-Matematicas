...
The basic elements of a gauge theory under the traditional formalism are:
    \begin{itemize}
    ...
    \end{itemize}
It is precisely the principal connection-induced notion of covariant derivative for matter fields which encodes the \emph{principle of gauge invariance} of the equations of motion that characterizes gauge theories. 
...
\ptext{Throughout this document every construction will occur over the category of smooth manifolds, so all vector bundles, sections of vector bundles, and any other function will be smooth; furthermore, a vector bundle will only be considered to be of finite rank}.
