...
\end{align*}
formally introduced in definition \ref{AtiyahSeq}.
...
\end{equation}
 When doing computations, it will be important to have in mind this sequences, perhaps replacing some of the elements by isomorphic ones, like we did in the Atiyah sequence of a principal bundle \ref{AtiyahSeq}.
\end{remark}
...
\begin{eqnsplit}\label{formulasij}
