...
\end{itemize}  which satisfy (mejor escribirlo en terminos del bundle, como se hace con una metrica o un producto interno: en efecto implican tal estructura en el espaci ovectorial de secciones, pero pues ese es otro lenguaje):
