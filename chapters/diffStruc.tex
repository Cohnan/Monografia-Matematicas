...
\end{align}
where $\{Im, Jm, Km \}$ is the restriction to the respective neighborhood of the global forms $\{Im, Jm, Km\} \subset \Omega^1(S^2 \times i\RR)$ dual to the global frame $\{i, j, k\} \in C^\infty(S^4, Im \HH)$.
\end{example}
