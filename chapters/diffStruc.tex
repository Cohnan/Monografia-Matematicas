...
\begin{definition}
Let $E$ be a LAB over $M$ on which there is a representation $\phi: A \to \alg D(E)$ of $A$. Define the differential  by the Koszul formula
\begin{eqnsplit}
\hat d_\phi: \Omega^{\bullet}(A, E) &\to \Omega^{\bullet+1}(A, E)\\
(\hat d_\phi \omega)(\sectoid X_1, \dots, \sectoid X_{p+1}) &= \sum \\
& + \sum 
\end{eqnsplit}
$\omega$ $p$-form
