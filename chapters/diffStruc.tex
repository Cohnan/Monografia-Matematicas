...
\begin{definition}
Let $\mathcal A = \oplus_{n = 0}^\infty \mathcal A^k$ be a graded algebra (over $\RR$).
    \begin{itemize}
...
\begin{proposition}
$(\Omega^\bullet(A, L), \wedge, \hat d)$ is a graded differential module over the graded commutative differential algebra $\Omega^\cdot(A)$, through the linear extension of the action:
\begin{align*}
