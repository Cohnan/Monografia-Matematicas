...
The $\bb K$-linear map $\hat d_\phi : \Gamma \Alt^\bullet(A, E) \to \Gamma \Alt^\bullet(A, E)$ is a local operator.$d_U$: Leibniz w.r.t. functions giben by the previous definition.\todo{complete}.
\end{theorem}
\begin{proof}
