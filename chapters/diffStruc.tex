...
\rtext{Let $G \to P \to M$ be a principal bundle over $M$. The differential graded module $(\Omega^\bullet(TP/G, P \times \alg g/G), \hat d)$ is isomorphic to subset of $(\Omega^\bullet(TP) \otimes \alg g, d)$ associated to the $(R_*, Ad)$-equivariant $\alg g$ valued forms on $P$.}
\end{theorem}
