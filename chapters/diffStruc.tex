...
\begin{definition}
Let $\mathcal A = \oplus_{n = 0}^\infty \mathcal A^k$ be a graded algebra.
    \begin{itemize}
    ...
    \item An antiderivation is \emph{of degree $m$} if, for all homogeneous elements $\omega \in \mathcal A$,
    \begin{align*}
        |d\omega| = |\omega| + m.
    \end{align*}
    
    \item $\mathcal A$ equipped with an antiderivation $d: \mathcal A \to \mathcal A$ is a \emph{differential graded algebra} if $d \circ d = 0$ and the antiderivation has either degree $1$ of $-1$.
...
\begin{theorem}
Let $E$ be a LAB over $M$ on which there is a representation $\phi: A \to \alg D(E)$ of $A$. Then
    \begin{itemize}

    \item $(\Omega^{\bullet}(A, E), \wedge)$ is a graded algebra,
