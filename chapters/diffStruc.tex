...
\begin{definition}
Let $E$ be a vector bundle over $M$ on which there is a representation $\phi: A \to \alg D(E)$ of $A$. Let $U \subset M$\todo{Open? Doesn't matter? I care about $U$ open only}.
...
\begin{align}
    \omega &: \underbrace{A|_U \oplus \cdots \oplus A|_U}_{\text{$n$ times}} \to E_U, & \text{alternating, $\RR$-vector bundle morphism and}\\
